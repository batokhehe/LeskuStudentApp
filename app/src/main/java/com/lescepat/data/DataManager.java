...
import com.lescepat.data.local.DetailsOrderStorage;
import com.lescepat.data.local.HistoryStorage;
import com.lescepat.data.local.PaidOrderStorage;
import com.lescepat.data.local.ProductStorage;
import com.lescepat.data.local.StudyLevelStorage;
import com.lescepat.data.local.SubjectStorage;
import com.lescepat.data.local.TeacherOrderStorage;
import com.lescepat.data.local.UnpaidOrderStorage;
import com.lescepat.data.local.UpcomingScheduleStorage;
import com.lescepat.data.local.UserStorage;
import com.lescepat.data.local.WaitingOrderStorage;
import com.lescepat.data.remote.AuthAPI;
import com.lescepat.data.remote.HomeAPI;
import com.lescepat.data.remote.ScheduleAPI;
import com.lescepat.data.remote.StudyLevelAPI;
import com.lescepat.data.remote.SubjectAPI;
import com.lescepat.data.remote.TeacherOrderAPI;
import com.lescepat.data.remote.UserAPI;
...
import com.lescepat.data.remote.OrderAPI;
...
public class DataManager implements DataManagerType
{
    ...
    //ORDER
    @Override
    public Maybe<List<TeacherOrder>> getTeacherOrderList(int subjectId, int studyLevel, String schedule)
    {
        return Maybe.concat(sTeacherOrderStorage.getList(), sTeacherOrderAPI.findListSelected(subjectId, studyLevel, schedule).doOnSuccess(new Consumer<List<TeacherOrder>>()
        {
            @Override
